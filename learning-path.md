...
* **1.3: Critical Thinking**    
    ...
    - Course 1.3.1 [Introduction to Logic by Stanford University](https://www.coursera.org/learn/logic-introduction) - Coursera
...
* **2.2: Inspirational Leadership: Leading with Sense Specialization**
    ...
    - Courses 2.2.1 .. 2.2.4: [Inspirational leadership by HEC Paris](https://www.coursera.org/specializations/inspirational-leadership)
...
* **3.1: English Grammar & Writing Foundations** [REVISE]
    ...
    - Course links: []() ...
        ...
        * English for Media Literacy - Penn
...
### CASE STUDY: Content Strategies at Scale
---
...
* **5.1: Cloud Computing Specialization - University of Illinois at Urbana-Champaign**
    ...
    - Course links: []() - Coursera
        * Course 1: Cloud Computing Concepts, Part 1 | ~23hrs
        * Course 2: Cloud Computing Concepts, Part 2 | ~20hrs
        * Course 3: Cloud Computing Applications, Part 1: Cloud Systems and Infrastructure | ~15hrs
        * Course 4: Cloud Computing Applications, Part 2: Big Data and Applications in the Cloud | ~20hrs
        * Course 5: Cloud Networking | ~23hrs
        * Course 6: Cloud Computing Project | ~21hrs
    - Difficulty & length: ~122hrs
    - Resources:
    - Skills gained: 


LEARNING PATHS
* **5.2: Developing Applications with Google Cloud Specialization**
    - Description: 
...
* **Google Cloud Certifications**
    ...
    - Course links: []() - Coursera, Skillsboost / Quiklabs
        * Google Certified - Hybrid and Multi-Cloud Architect 
    - Difficulty & length:
    - Resources: 
    - Skills gained:
...
* **AWS Cloud Certifications**
    ...
    - Course links: []() - Coursera, Quiklabs
...
* **Azure Cloud Certifications**
    ...
    - Course links: []() - Coursera, Quiklabs
        * Microsoft Certified - A zure DevOps Engineer Expert
    - Difficulty & length:
    - Resources: 
    - Skills gained:

* **Red Hat & IBM Cloud Certifications**
    - Description: This course is focused on system administration, integration, and deployment on RedHat OpenShift using a hybrid multi-cloud strategy.

    - Course links: []() - IBM Training & Coursera
        * Red Hat (Learning Subsciption)
            - Red Red Hat Certified System Administrator (RHCSA)
                * Exam: EX200 - Red Hat Certified System Administrator
            - Red Hat Certified Engineer (FHCE)
                * Exam: EX294 - Red Hat Certified Engineer
            - Red Hat Certified Architect (RHCA)
                * Course 1: Red Hat Certified Specialist in Hybrid Cloud Management
                * Course 2: Red Hat Certified Specialist in Ansible Network Automation
                * Course 3: Red Hat Certified Specialist in OpenShift Automation and Integration
                * Course 4: Red Hat Certified Specialist in Deployment and Systems Management
                * Course 5: Red Hat Certified Specialist in Ansible Advanced Automation
        * IBM Training (Learning Subscription)
...
* **Deep-Dive: Artificial Intellicence (AI / ML)**
...
## TOPIC 2: MULTI-DISCIPLINARY DESIGN
    ...
    >> User Experience Design, Mechanical Engineering (Industrial), Architectural (Interior, Space Planning), Software Development, Electrical / Computer Engineering (Hardware)
